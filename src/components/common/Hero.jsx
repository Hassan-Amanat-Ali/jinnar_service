      ...
      <div>
        {place === "home" && (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 px-4 sm:px-6 lg:px-8 my-6 sm:my-8 md:my-10 lg:mt-18 w-full sm:w-[90%] md:w-[85%] lg:w-[97%] xl:w-[90%] 2xl:w-[85%] max-w-7xl mx-auto relative">
              ...
              <div className="absolute inset-x-0 bottom-0 h-12 sm:h-16 md:h-20 lg:h-24 bg-gradient-to-t from-white via-white/80 to-transparent rounded-xl pointer-events-none" />
            </div>
          </>
        )}
      </div>
            ...
            <div className="w-full max-w-6xl mx-auto bg-white shadow-lg rounded-2xl p-4 sm:p-6 space-y-5 mt-15">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <Dropdown
                  ...
                  icon={<Calendar size={18} className="text-sky-500 mr-2" />}
                  placeholder="All Availability"
                  options={["Available Now", "Weekdays", "Weekends"]}
                  isOpen={openDropdown === "availability"}
                  onToggle={() => handleDropdownToggle("availability")}
                  onSelect={(value) => console.log("Availability:", value)}
                />
