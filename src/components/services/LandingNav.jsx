        ...
        <div className="flex items-center justify-start sm:justify-center gap-2 sm:gap-3 md:gap-4 overflow-x-auto scrollbar-hide py-3">
          {isLoading ? (
            ...
            services.map((service, index) => (
              <button
                key={index}
                className={`cursor-pointer shrink-0 text-xs px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-2xl sm:rounded-2xl whitespace-nowrap transition-all duration-200 ${
