    ...
    <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-lg p-3 sm:p-4 md:p-5 border border-gray-100 sm:h-92">
      ...
      <div className="flex items-start sm:items-center gap-2 sm:gap-3 min-h-[3rem] sm:h-18">
        ...
        <div className="flex flex-col sm:flex-row gap-1 sm:gap-2 flex-shrink-0">
          ...
          <span
            className={`px-1.5 sm:px-2 py-0.5 sm:py-1 text-xs rounded-lg font-light whitespace-nowrap  ${
              statusTag === "Completed"
      ...
      {/* Details */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2 mt-3 sm:mt-4 text-xs sm:text-sm text-gray-700 sm:h-25">
        <div className="flex items-center gap-1 sm:gap-2">
          <Calendar
            size={14}
            className="text-[#74C7F2] flex-shrink-0 sm:w-4 sm:h-4"
          />
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="truncate font-semibold text-xs">{time}</span>
          </div>
        </div>
        <div className="flex items-center gap-1 sm:gap-2 xs:col-span-2">
          <MapPin
            size={14}
            className="text-[#74C7F2] flex-shrink-0 sm:w-4 sm:h-4"
          />
          <div className="flex flex-col">
            ...
            <span className="truncate text-xs sm:text-xs font-semibold">
              {location.slice(0, 20)}...
            </span>
          </div>
        </div>
